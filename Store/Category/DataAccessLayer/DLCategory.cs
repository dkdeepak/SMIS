...
namespace Store.DataAccessLayer
{
    public class Category
    {
        ...
        {
            Store.BusinessObject.CategoryList objCategoryList = new BusinessObject.CategoryList();
            Store.BusinessObject.Category objCategory = new BusinessObject.Category();
        ...
        {
            Store.BusinessObject.Category objCategory = null;
            string SQL = string.Empty;
            ParameterList paramList = new ParameterList();
            DataTableReader dr;
            try
        ...
        public Store.Common.MessageInfo ManageCategory(Store.BusinessObject.Category objCategory, CommandMode cmdMode)
        {
            string SQL = "";
