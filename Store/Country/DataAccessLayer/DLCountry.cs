...
namespace Store.DataAccessLayer
{
    public class Country
    {
        ...
        {
            Store.BusinessObject.CountryList objCountryList = new BusinessObject.CountryList();
            Store.BusinessObject.Country objCountry = new BusinessObject.Country();
        ...
        public Store.Common.MessageInfo ManageCountry(Store.BusinessObject.Country objCountry, CommandMode cmdMode)
        {
            string SQL = "";
